...
// Multilanguage Install for Zen Cart German 2019-07-10 webchills
//
...
define('NEWS_BOX_CURRENT_UPDATE_DATE', '2019-07-10');
...
if ($configuration->EOF) {
  $db->Execute("INSERT INTO " . TABLE_CONFIGURATION_GROUP . " 
                 ...
                 VALUES ('$configurationGroupTitle', '$configurationGroupTitle Settings', '43', '1', '1');");
  $cgi = $db->Insert_ID(); 
...
('Datumsformat im Newsarchiv', 'NEWS_BOX_DATE_FORMAT', 'short = 20.12.2019<br/>long = Dienstag, 20. Dezember 2019', 43),
